  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        @if(auth()->check())
          <li class="nav-item">
            <a class="nav-link" href="{{ route('add-post') }}">add a Post</a>
          </li>
          <li class="nav-item">
          ...
          @if(auth()->user()->is_admin)
            <li class="nav-item">
            <a class="nav-link" href="{{ route('profile.show') }}">Admin</a>
          </li>
          @endif
        </ul>
        ...
        <a style="margin-right: 2px" class="btn btn-dark" href="{{ url('/login') }}">login</a>
